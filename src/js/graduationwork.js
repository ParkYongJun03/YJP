...
const details_paper = document.querySelector('#paper');
const details_graduationwork = document.querySelector('#graduationwork');
...
details_paper.addEventListener('toggle', ()=>{
    console.log('paper');
    web_scroll.setAttribute('max', document.body.clientHeight-window.innerHeight);
});
details_graduationwork.addEventListener('toggle', ()=>{
    console.log('graduationwork');
    web_scroll.setAttribute('max', document.body.clientHeight-window.innerHeight);
});
